const socialIcons = [
  {
    icon: (
      <svg
        ...
        height="24"
        viewBox="0 0 24 24"
        className="size-6 fill-zinc-500"
      >
      ...
      <div className="container">
        ...
        <div className="mt-12 md:mt-48 md:flex md:justify-between md:items-center">
          <p className="text-zinc-400">
            &copy; 2024 Sascha Schmittinger. All rights reserved
          </p>
          <div className="mt-4 md:mt-0 flex gap-6">
            {socialIcons.map((icon, iconIndex) => (
              <div
                key={iconIndex}
                className="inline-flex items-center justify-center size-10 bg-zinc-800 rounded-full"
              >
                {icon.icon}
              </div>
            ))}
